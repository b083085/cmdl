...
namespace CMDLWpf
{
    public class Test_CultureAndSensitivity : NotifyPropertyChanged
    {
        ...
        private List<Test_CultureAndSensitivity_Item> _itemList = new List<Test_CultureAndSensitivity_Item>();
        public List<Test_CultureAndSensitivity_Item> ItemList
        {
