    ...
    class PregTest_PrintDoc
    {
        ...
        void doc_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                //Results and remarks
                e.Graphics.DrawString("PREGNANCY TEST", labelinfo_bold, black, new RectangleF(new PointF(20, 250), new SizeF(111, 100)), new StringFormat() { Alignment = StringAlignment.Center });
                e.Graphics.DrawString(info[ctr].Pregnancy_Test.Results, labelinfo_bold, black, new RectangleF(new PointF(131, 250), new SizeF(222, 20)), new StringFormat() { Alignment = StringAlignment.Center });
                e.Graphics.DrawString(info[ctr].Pregnancy_Test.Remarks, labelinfo_bold, black, new RectangleF(new PointF(353, 250), new SizeF(444, 60)), new StringFormat() { Alignment = StringAlignment.Near });

                //signatories
                if (info[ctr].Pregnancy_Test.MedTech != null)
                {
                    e.Graphics.DrawString(info[ctr].Pregnancy_Test.MedTech, radfont, black, new RectangleF(new Point(20, 580), new SizeF(388, 20)), new StringFormat() { Alignment = StringAlignment.Center });
                ...
                {
                    e.Graphics.DrawString(info[ctr].Pregnancy_Test.Pathologist, radfont, black, new RectangleF(new Point(408, 580), new SizeF(388, 20)), new StringFormat() { Alignment = StringAlignment.Center });
                ...
                e.Graphics.DrawString("Printed By: " + info[ctr].Pregnancy_Test.PrintedBy, printedbyfont, black, new Point(20, 605));
