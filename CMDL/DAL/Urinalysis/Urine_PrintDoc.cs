...
namespace CMDL
{
    class Urine_PrintDoc
    {
        ...
        private void Body(PrintPageEventArgs e)
        {
            ...
            //RBC
            e.Graphics.DrawString("(NORMAL VALUES)", new Font("Arial",8F), black, new Point(680, 215));
            ...
            if (!String.IsNullOrWhiteSpace(info[ctr].Urinalysis.RBC))
            {
                ...
                e.Graphics.DrawString("N.V.: 0-5/hpf", labelinfo_bold, black, new Point(690, 250));
            }
            //WBC
            ...
            if (!String.IsNullOrWhiteSpace(info[ctr].Urinalysis.WBC))
            {
                ...
                e.Graphics.DrawString("N.V.: 0-5/hpf", labelinfo_bold, black, new Point(690, 270));
            }
            //EPITHELIAL CELLS
            ...
            if (!String.IsNullOrWhiteSpace(info[ctr].Urinalysis.Epithelial_Cells))
                e.Graphics.DrawString(info[ctr].Urinalysis.Epithelial_Cells + " /lpf", labelinfo_bold, black, new Point(580, 290));
            //BACTERIA
        ...
        void doc_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                //Title bar
                e.Graphics.FillRectangle(Brushes.YellowGreen, new Rectangle(20, 190, 776, 20));
                e.Graphics.DrawRectangle(Pens.Black, new Rectangle(20, 190, 776, 20));
                e.Graphics.DrawString("URINALYSIS", titlebarfont, Brushes.White, new RectangleF(new Point(20, 190), new SizeF(776, 20)), new StringFormat() { Alignment = StringAlignment.Center });
                ...
                //signatories
                if (!String.IsNullOrWhiteSpace(info[ctr].Urinalysis.MedTech))
                {
                    e.Graphics.DrawString(info[ctr].Urinalysis.MedTech, radfont, black, new RectangleF(new Point(20, 580), new SizeF(388, 20)), new StringFormat() { Alignment = StringAlignment.Center });
                ...
                if (!String.IsNullOrWhiteSpace(info[ctr].Urinalysis.Pathologist))
                {
                    e.Graphics.DrawString(info[ctr].Urinalysis.Pathologist, radfont, black, new RectangleF(new Point(408, 580), new SizeF(388, 20)), new StringFormat() { Alignment = StringAlignment.Center });
                ...
                e.Graphics.DrawString("Printed By: " + info[ctr].Urinalysis.PrintedBy, printedbyfont, black, new Point(20, 605));
