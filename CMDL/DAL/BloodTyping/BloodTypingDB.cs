...
namespace CMDL
{
    public class BloodTypingDB : MySqlDB
    {
        public string ControlNo { set; get; }

        public BloodTypingDB(string database)
            : base(database)
        {
            //get database
        }

        public BloodTypingDB(string server, string database, string uid, string port, string password)
            : base(server, database, uid, port, password)
        {
            //get server,database,uid,port and password
        }

        public BloodTyping_Data Data
        {
            set;
            get;
        }
